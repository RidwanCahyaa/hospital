                ...
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-7 wow fadeInRight" data-wow-delay="0.4s">
                        <div class="section-title text-start mb-5">
                            ...
                            <h1 class="display-3 mb-4">Klinik Rehabilitas Medis</h1>
                            <p class="mb-4">Klinik rehabilitas medis adalah fasilitas kesehatan yang menyediakan layanan rehabilitasi bagi individu yang mengalami keterbatasan fisik, fungsional, atau mobilitas akibat cedera, penyakit, atau kondisi medis lainnya. Tujuan utama klinik ini adalah membantu pasien memulihkan fungsi tubuh, meningkatkan kualitas hidup, dan mencegah kecacatan lebih lanjut.</p>
                            <div class="mb-4">
                                <p class="text-secondary"><i class="fa fa-check text-primary me-2"></i> Terapi Fisik.</p>
                                <p class="text-secondary"><i class="fa fa-check text-primary me-2"></i> Terapi Bicara.</p>
                                <p class="text-secondary"><i class="fa fa-check text-primary me-2"></i> Program Pendidikan dan Konseling.</p>
                            </div>
