        ...
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-7 wow fadeInRight" data-wow-delay="0.4s">
                <div class="section-title text-start mb-5">
                    ...
                    <h1 class="display-3 mb-4">Klinik Penyakit Dalam</h1>
                    <p class="mb-4">fasilitas kesehatan yang fokus pada diagnosis, pengobatan, dan manajemen penyakit yang bersifat non-bedah pada orang dewasa..</p>
                    <div class="mb-4">
                        <p class="text-secondary"><i class="fa fa-check text-primary me-2"></i> Menangani berbagai penyakit.</p>
                        <p class="text-secondary"><i class="fa fa-check text-primary me-2"></i> Melakukan pemeriksaan fisik dan tes laboratorium.</p>
                        <p class="text-secondary"><i class="fa fa-check text-primary me-2"></i> Mengelola kondisi kronis melalui pemantauan dan penyesuaian terapi yang tepat.</p>
                    </div>
                </div>
            </div>
        </div>
