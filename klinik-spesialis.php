                ...
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-7 wow fadeInRight" data-wow-delay="0.4s">
                        <div class="section-title text-start mb-5">
                            ...
                            <h1 class="display-3 mb-4">Klinik Spesialis Kedokteran Okupasi</h1>
                            <p class="mb-4">Klinik spesialis kedokteran okupasi adalah fasilitas kesehatan yang fokus pada diagnosis, pengobatan, dan pencegahan masalah kesehatan yang berkaitan dengan pekerjaan. Spesialis kedokteran okupasi (occupational medicine) memiliki keahlian dalam memahami bagaimana faktor lingkungan kerja dapat mempengaruhi kesehatan fisik dan mental pekerja.</p>
                            <div class="mb-4">
                                <p class="text-secondary"><i class="fa fa-check text-primary me-2"></i> Pemeriksaan Kesehatan Kerja.</p>
