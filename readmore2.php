        ...
        <div class="row g-5 align-items-center">
            <div class="col-lg-5 wow fadeInLeft" data-wow-delay="0.2s">
                <div class="about-img pb-5 ps-5">
                    <img src="img/blog-2.jpg" class="img-fluid rounded w-100" style="object-fit: cover;" alt="Image">
            ...
            <div class="col-lg-7 wow fadeInRight" data-wow-delay="0.4s">
                <div class="section-title text-start mb-5">
                    ...
                    <h1 class="display-3 mb-4">gejala sakit otot</h1>
                    <p class="mb-4">Cedera olahraga dan ketegangan karena penggunaan berlebih adalah penyebab paling umum nyeri otot. Mari perhatikan bagaimana mengenali dan menangani nyeri otot <div class="mb-4">
