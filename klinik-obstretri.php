                ...
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-7 wow fadeInRight" data-wow-delay="0.4s">
                        <div class="section-title text-start mb-5">
                            ...
                            <h1 class="display-3 mb-4">Klinik Obstetri & Ginekologi</h1>
                            <p class="mb-4">Klinik obstetri dan ginekologi (Obgyn) adalah fasilitas kesehatan yang menyediakan layanan khusus untuk kesehatan wanita, terutama terkait dengan sistem reproduksi dan kehamilan.</p>
                            <div class="mb-4">
                                <p class="text-secondary"><i class="fa fa-check text-primary me-2"></i> Pemantauan kehamilan dan kesehatan janin.</p>
                                <p class="text-secondary"><i class="fa fa-check text-primary me-2"></i> Pemeriksaan kesehatan rutin, seperti Pap smear dan pemeriksaan payudara.</p>
                                <p class="text-secondary"><i class="fa fa-check text-primary me-2"></i> Manajemen persalinan, termasuk persalinan normal dan caesar.</p>
                            </div>
