                ...
                <div class="row g-5">
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <p>keadaan kesejahteraan fisik, mental, dan sosial yang lengkap, bukan hanya terbebas dari penyakit atau kelemahan. 
                            </p>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-3">
                        <div class="footer-item d-flex flex-column">
                            ...
                            <a href=""><i class="fa fa-map-marker-alt me-2"></i> Jl. Rancaekek No.Km.27, RW.No.612, Nanjungmekar, Kec. Rancaekek, Kabupaten Bandung, Jawa Barat 40394</a>
                            <a href=""><i class="fas fa-envelope me-2"></i>  rskk@jabarprov.go.id.</a>
                            <a href=""><i class="fas fa-envelope me-2"></i>  rskk@jabarprov.go.id.</a>
